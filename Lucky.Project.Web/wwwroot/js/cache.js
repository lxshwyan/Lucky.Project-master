    ...
    function showNotice() {
        layer.open({
            ...
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;">' +
                '<p>Lucky后台管理系统正式上线啦，界面采用贤心最新版layui及马哥的layuicms</p>' +
                '<p>喜欢的，快快star吧！</p></div>',
    ...
    function lockPage() {
        layer.open({
            ...
            content: '<div class="admin-header-lock" id="lock-box">' +
                '<div class="admin-header-lock-img"><img src="images/userface.jpg" class="userAvatar"/></div>' +
                '<div class="admin-header-lock-name" id="lockUserName">lxsh</div>' +
                '<div class="input_btn">' +
